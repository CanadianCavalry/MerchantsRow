...
<body>
	<div class="page-container" id="home">
		...
		<div class="center-page" id="worker-table">
			<h1>Your Workers</h1>
			<?php include "../scripts/callWorkers.php"?>
			<h1>Workers For Hire</h1>
			<?php include "../scripts/callWorkersToHire.php";
			callWorkersToHire($LinkID);
			?>
		</div>
	</div>
</body>
